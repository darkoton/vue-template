          ...
          <div class="template__wrapper">
            <div class="template__container _container">
              <div class="template__body">
                ...
                <h1 class="template__title text-center">
                  This is home page Vue tamplate
                </h1>

                <p class="template__text text-center">
                  This template contains useful developments for web application
                  development in Vue
                </p>

                <h2 class="template__subtitle text-center">
